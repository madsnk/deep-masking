    ...
    for it in xrange(num_iters):
      ...
      for p in model:
        ...
        if update == 'sgd':
          ...
          self.step_cache[p] = momentum * self.step_cache[p] - learning_rate * grads[p] # add momentum to vanilla SGD
          dx = self.step_cache[p] # Here dx is the update step to take and NOT the gradient
          ...
          eps = 10**-8 # smoothing term. Avoids division by 0
